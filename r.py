...
class PicsWindow(QWidget):
    ...
    def generate_and_update(self):
        ...
        # Run network call in a separate thread so the WinUI/PyQt window doesn't freeze
...
# FastAPI Server Extension for Alice Backend Integration
app = FastAPI()

@app.post("/api/pics/toggle")
def toggle_pics_window():
    # Spawns the Pics desktop window process independently
